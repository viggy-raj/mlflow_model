...
from .views.model_views import ModelListView, ModelTrainView, ActiveModelView, ModelApproveView
from .views.rollout_views import RolloutStartView, RolloutStatusView, RolloutAdvanceView, RolloutRollbackView, RolloutLogsView
...
urlpatterns = [
    ...
    path('models/approve/', ModelApproveView.as_view(), name='model-approve'),
    ...
    path('rollout/<int:pk>/logs/', RolloutLogsView.as_view(), name='rollout-logs'),
